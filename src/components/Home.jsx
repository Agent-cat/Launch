...
const Home = () => {
  ...
  const handleVideoEnd = () => {
    window.location.href = "https://klfemflare.in";
  };
    ...
    >
      ...
      {showVideo ? (
        <div className="fixed inset-0 z-50 bg-black flex items-center justify-center">
          ...
          >
            <source src="/logorevel.mp4" type="video/mp4" />
        ...
        <div className="container mx-auto  text-center flex flex-col items-center justify-center h-screen relative">
          ...
          <button
            ...
            className="mt-96 px-8 py-3 bg-white hover:bg-gray-200 rounded-full text-black font-semibold text-lg tracking-wide shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
          >
            Launch Website
          </button>
